...
my_exception::my_exception( const std::string &error, my_exception *init_reason /*= nullptr*/, const char *file /*= nullptr*/ ,
...
{}
my_exception::my_exception( const int error, my_exception *init_reason /*= nullptr*/, const char *file /*= nullptr*/ ,
                            const int line /*= -1*/, const char *func /*= nullptr*/) noexcept(true)
...
void my_exception::dumpErrSource()
{
...
void my_exception::dumpErrCodeExplanation()
{
